 ...
 */
class Provider_FreeGeoIp extends Provider_Abstract implements Provider_Interface
{
    /**
     * @var string
     */
    ...
    {
        throw new Exception_Unsupported('The FreeGeoIpProvider is not able to do reverse geocoding.');
    }
