 ...
 */
class Provider_BingMaps extends Provider_Abstract implements Provider_Interface
{
    /**
     * @var string
     */
     ...
     * @param string                                     $locale
     */
    public function __construct(HttpAdapter_Interface $adapter, $apiKey, $locale = null)
    {
