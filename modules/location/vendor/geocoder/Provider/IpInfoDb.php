 ...
 */
class Provider_IpInfoDb extends Provider_Abstract implements Provider_Interface
{
    /**
     * @var string
     */
     ...
     * @param string                                     $apiKey
     */
    public function __construct(HttpAdapter_Interface $adapter, $apiKey)
    {
    ...
    {
        throw new Exception_Unsupported('The IpInfoDbProvider is not able to do reverse geocoding.');
    }
