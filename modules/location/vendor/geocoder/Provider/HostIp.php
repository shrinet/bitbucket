 ...
 */
class Provider_HostIp extends Provider_Abstract implements Provider_Interface
{
    /**
     * @var string
     */
    ...
    {
        throw new Exception_Unsupported('The HostIpProvider is not able to do reverse geocoding.');
    }
