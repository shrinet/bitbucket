...
class User extends Phpr_User
{
	...
	public static function update_user_merchantDetails($user,$id,$status)
    {
        $bind = array(
            'id' => $user->id,
        ...
        Db_Helper::query('update users set submerchantAccountId=:submerchantAccountId, submerchantStatus=:submerchantStatus where id=:id', $bind);
        return;
    }	
